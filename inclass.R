...
matrix
matrix <-matrix(c(1,2,3,4,5,6), nrow=2, byrow=TRUE) ##row 기준으로 데이터를 삽입함
matrix
...
matrix2
matrix3
array <-array(c(matrix1, matrix2, matrix3), dim=c(3,3,3)) ##3x3x3 정육면체 현태로 출력됨
array
